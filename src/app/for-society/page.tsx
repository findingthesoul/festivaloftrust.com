...
export const metadata: Metadata = {
  title: "For society",
  description:
    "How a community hosts a Festival of Trust in its own place, with the backing of a funder — nine steps, local hands, trust grown by doing.",
  alternates: { canonical: "/for-society" },
};
